...
public class MemberResponse {
    ...
    @ApiModelProperty(value = "第一邀请人主键")
    private Long firstInviterId;

    @ApiModelProperty(value = "第一邀请人标识")
    private String firstInviterUsername;

    @ApiModelProperty(value = "第二邀请人主键")
    private Long secondInviterId;

    @ApiModelProperty(value = "第二邀请人标识")
    private String secondInviterUsername;

    @ApiModelProperty(value = "第三邀请人主键")
    private Long thirdInviterId;

    @ApiModelProperty(value = "第三邀请人标识")
